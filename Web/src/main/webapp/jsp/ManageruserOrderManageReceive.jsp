                                    ...
                                    <div class="row">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                <li class="text-center"><a href="/order/modifyManagerOrderBybackpay/ManageruserOrderManageReceive/0/3/${detail.orderId}">同意退款</a></li>
                                                <li class="text-center"><a href="/order/modifyManagerOrderBybackpay/ManageruserOrderManageReceive/0/4/${detail.orderId}">拒绝退款</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </c:when>
                                <c:when test="${Item.orderStatus.backpay==2}">
                                    <div class="row">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                <li class="text-center"><a href="/order/modifyManagerOrderBybackpay/ManageruserOrderManageReceive/0/5/${detail.orderId}">同意退货</a></li>
                                                <li class="text-center"><a href="/order/modifyManagerOrderBybackpay/ManageruserOrderManageReceive/0/6/${detail.orderId}">拒绝退货</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </c:when>

...
<c:if test="${list.size()==0}">
    <div class="container">
        <div class="row" style="height: 300px">
            <h1 class="text-center" style="margin-top: 10%">待发货订单为空</h1>
        </div>
    </div>
</c:if>
                                    ...
                                    <div class="row">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                <li class="text-center"><a href="/order/modifyManagerOrderBybackpay/ManageruserOrderManageSend/2/3/${detail.orderId}">同意退款</a></li>
                                                <li class="text-center"><a href="/order/modifyManagerOrderBybackpay/ManageruserOrderManageSend/2/4/${detail.orderId}">拒绝退款</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </c:when>
                                <c:when test="${Item.orderStatus.backpay==2}">
                                    <div class="row">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                <li class="text-center"><a href="/order/modifyManagerOrderBybackpay/ManageruserOrderManageSend/2/5/${detail.orderId}">同意退货</a></li>
                                                <li class="text-center"><a href="/order/modifyManagerOrderBybackpay/ManageruserOrderManageSend/2/6/${detail.orderId}">拒绝退货</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </c:when>

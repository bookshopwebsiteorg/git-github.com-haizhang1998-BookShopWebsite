...
<div class="content">
    <div class="container">
        <div class="content-header">
            <a href="/order/queryAllManagerOrderByUserId">所有订单</a><span >|</span>
            <a href="/order/queryManagerOrderByStatus/ManageruserOrderManagePay/1">待付款</a><span>|</span>
            <a href="/order/queryManagerOrderByStatus/ManageruserOrderManageSend/2">待发货</a><span >|</span>
            <a href="/order/queryManagerOrderByStatus/ManageruserOrderManageReceive/3">待收货</a><span >|</span>
            <a href="/order/queryManagerOrderByStatus/ManageruserOrderManageEvaluate/4">待评价</a>
        </div>
        <hr>
    </div>
</div>
...
<c:if test="${list.size()==0}">
    <div class="container">
        <div class="row" style="height: 300px">
            <h1 class="text-center" style="margin-top: 10%">待评价订单为空</h1>
        </div>
    </div>
</c:if>
                    ...
                    <div class="col-md-2 text-center">
                        <c:choose>
                            <c:when test="${Item.orderStatus.status >= 4 && Item.orderStatus.status<=6}">
                                <a href="/order/deleteManagerOrder/${Item.orderId}" class="glyphicon glyphicon-trash" style="padding:10px">删除订单</a>
                            </c:when>
                        </c:choose>
                    </div>
                </div>
                ...
                <div class="container" style="border: 1px solid black;">
                    <div class="row">
                        ...
                        <div class="goodsItemLi col-md-2 text-center">
                            <div class="row">
                                <c:choose>
                                    ...
                                    <c:when test="${Item.orderStatus.status==7}">买家催促发货</c:when>
                                </c:choose>
                            </div>
                            <div class="row">
                                <c:choose>
                        ...
                        <div class="goodsItemLi col-md-2 text-center">
                            <div class="row">
                                <c:choose>
                                    <c:when test="${Item.orderStatus.status==1}">等待买家付款</c:when>
                                    <c:when test="${Item.orderStatus.status==2 ||Item.orderStatus.status==7}">买家已付款</c:when>
                                    <c:when test="${Item.orderStatus.status==3}">等待买家签收</c:when>
                        ...
                        <div class="goodsItemLi col-md-1 text-center" style="margin-top: 7px;">
                            <c:choose>
                                <c:when test="${Item.orderStatus.status==2 || Item.orderStatus.status==7}">
                                    <div class="row">
                                        <a href="/order/modifyManagerOrderStatus/ManageruserOrderManageEvaluate/3/${detail.orderId}" class="btn btn-primary btn-sm active" role="button">发货</a>
                                    </div>
                                </c:when>
                                <c:when test="${Item.orderStatus.status==6}">
                                    <div class="row">
                                        已评价
                                    </div>
                                </c:when>
                            ...
                            <c:choose>
                                <c:when test="${Item.orderStatus.status<=3 || Item.orderStatus.status==7}">
                                    <div class="row">
                                        <a href="/order/modifyManagerOrderStatus/ManageruserOrderManageEvaluate/5/${detail.orderId}" class="btn btn-primary btn-sm active" role="button">取消订单</a>
                                    </div>
                                </c:when>
                            </c:choose>
                            <c:choose>
                                <c:when test="${Item.orderStatus.backpay==1}">
                                    <div class="row">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                <li class="text-center"><a href="/order/modifyManagerOrderBybackpay/ManageruserOrderManageEvaluate/4/3/${detail.orderId}">同意退款</a></li>
                                                <li class="text-center"><a href="/order/modifyManagerOrderBybackpay/ManageruserOrderManageEvaluate/4/4/${detail.orderId}">拒绝退款</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </c:when>
                                <c:when test="${Item.orderStatus.backpay==2}">
                                    <div class="row">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                <li class="text-center"><a href="/order/modifyManagerOrderBybackpay/ManageruserOrderManageEvaluate/4/5/${detail.orderId}">同意退货</a></li>
                                                <li class="text-center"><a href="/order/modifyManagerOrderBybackpay/ManageruserOrderManageEvaluate/4/6/${detail.orderId}">拒绝退货</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </c:when>
                                <c:when test="${Item.orderStatus.backpay==7}">
                                    <div class="row">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                <li class="text-center"><a href="/order/modifyManagerOrderBybackpay/ManagerOrderManageEvaluate/4/8/${detail.orderId}">确认签收</a></li>
                                                <li class="text-center"><a href="/order/modifyManagerOrderBybackpay/ManagerOrderManageEvaluate/4/9/${detail.orderId}">拒绝签收</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </c:when>

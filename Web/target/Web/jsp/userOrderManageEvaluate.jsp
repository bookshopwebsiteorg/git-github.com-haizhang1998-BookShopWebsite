                            ...
                            <div class="row">
                                <c:choose>
                                    ...
                                    <c:when test="${Item.orderStatus.backpay==5}">
                                        同意退货申请
                                        <%--<a href="/order/modifyUserOrderBybackpay/userOrderManageEvaluate/4/7/${detail.orderId}">填写退货信息</a>--%>
                                    </c:when>
                        ...
                        <div class="goodsItemLi col-md-1 text-center" style="margin-top: 7px;">
                            <c:choose>
                                <c:when test="${Item.orderStatus.status==1}">
                                    <div class="row">
                                        <a href="/order/modifyUserOrderStatus/userOrderManageEvaluate/2/${detail.orderId}" class="btn btn-danger btn-sm active" role="button">立即付款</a>
                                    </div>
                                    <div class="row">
                                        <a href="/order/modifyUserOrderStatus/userOrderManageEvaluate/5/${detail.orderId}" class="btn btn-primary btn-sm active" role="button">取消订单</a>
                                    </div>
                                </c:when>
                                    ...
                                    <div class="row">
                                        <c:choose>
                                            <c:when test="${Item.orderStatus.status==7}">
                                                <a href="/order/modifyUserOrderStatus/userOrderManageEvaluate/7/${detail.orderId}" class="btn btn-primary btn-sm disabled" role="button">提醒发货</a>

                                            </c:when>
                                            <c:otherwise>
                                                <a href="/order/modifyUserOrderStatus/userOrderManageEvaluate/7/${detail.orderId}" class="btn btn-primary btn-sm active" role="button">提醒发货</a>
                                            </c:otherwise>
                                        </c:choose>
                                    </div>
                                    <c:choose>
                                            ...
                                            <div class="row">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                        <li class="text-center"><a href="/order/modifyUserOrderBybackpay/userOrderManageEvaluate/4/1/${detail.orderId}">仅退款(未收到货)</a></li>
                                                        <li class="text-center"><a href="/order/modifyUserOrderBybackpay/userOrderManageEvaluate/4/2/${detail.orderId}">退货退款(已收到货)</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </c:when>
                                ...
                                <c:when test="${Item.orderStatus.status==3}">
                                    ...
                                    <div class="row">
                                        <a href="/order/modifyUserOrderStatus/userOrderManageEvaluate/4/${detail.orderId}" class="btn btn-primary btn-sm active" role="button">确认收货</a>
                                    </div>
                                    <c:choose>
                                        <c:when test="${Item.orderStatus.backpay==0||Item.orderStatus.backpay==4||Item.orderStatus.backpay==6}">
                                            <div class="row">
                            ...
                            <c:choose>
                                <c:when test="${Item.orderStatus.backpay==5}">
                                    <a href="/order/modifyUserOrderBybackpay/userOrderManageEvaluate/4/7/${detail.orderId}" class="btn btn-primary btn-sm active" role="button">寄回图书</a>
                                </c:when>
                            </c:choose>
                        </div>
                    </div>

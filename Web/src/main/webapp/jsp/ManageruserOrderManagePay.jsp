                        ...
                        <div class="goodsItemLi col-md-1 text-center" style="margin-top: 7px;">
                            <c:choose>
                                <c:when test="${Item.orderStatus.status==2 || Item.orderStatus.status==7}">
                                    <div class="row">
                                        <a href="/order/modifyManagerOrderStatus/ManageruserOrderManagePay/3/${detail.orderId}" class="btn btn-primary btn-sm active" role="button">发货</a>
                                    </div>
                                </c:when>
                            ...
                            <c:choose>
                                <c:when test="${Item.orderStatus.status<=3 || Item.orderStatus.status==7}">
                                    <div class="row">
                                        <a href="/order/modifyManagerOrderStatus/ManageruserOrderManagePay/5/${detail.orderId}" class="btn btn-primary btn-sm active" role="button">取消订单</a>
                                    </div>
                                </c:when>
                            </c:choose>
                            <c:choose>

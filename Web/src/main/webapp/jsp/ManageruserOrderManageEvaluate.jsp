        ...
        <div class="row" >
            <div class="container" style="<c:choose><c:when test="${Item.orderStatus.status==6||Item.orderStatus.status==5}">background-color: #cccccc;</c:when><c:otherwise>background-color: #a6e1ec;</c:otherwise></c:choose>height: 40px">
                <div class="row">
                    ...
                    <div class="col-md-2 text-center">
                        <a href="/merchant/chat/${Item.orderDetails.get(0).merchantId}" class="glyphicon glyphicon-user" style="padding:10px">联系买家</a>
                    </div>
                    <div class="col-md-2 text-center">
                        <c:choose>
                                    ...
                                    <div class="row">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                <li class="text-center"><a href="/order/modifyManagerOrderBybackpay/ManageruserOrderManageEvaluate/0/3/${detail.orderId}">同意退款</a></li>
                                                <li class="text-center"><a href="/order/modifyManagerOrderBybackpay/ManageruserOrderManageEvaluate/0/4/${detail.orderId}">拒绝退款</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </c:when>
                                <c:when test="${Item.orderStatus.backpay==2}">
                                    <div class="row">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                <li class="text-center"><a href="/order/modifyManagerOrderBybackpay/ManageruserOrderManageEvaluate/0/5/${detail.orderId}">同意退货</a></li>
                                                <li class="text-center"><a href="/order/modifyManagerOrderBybackpay/ManageruserOrderManageEvaluate/0/6/${detail.orderId}">拒绝退货</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </c:when>
